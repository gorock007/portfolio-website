...
export const projectsData = [
    {
        ...
        title: 'SummAIze',
        img: summaizeImg,
        description:"Articles summarizing tool powered by openI GPT-4. Developed using Vite ReactJs, Redux and Tailwindcss. SummAIze make the reading and reseach easier by condensing long artciles into short and concise summary.",
